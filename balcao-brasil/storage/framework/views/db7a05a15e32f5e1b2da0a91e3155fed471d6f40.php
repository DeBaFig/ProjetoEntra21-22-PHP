...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                    <span class="ml-2 text-sm text-gray-600"><?php echo e(__('Lembrar minha senha')); ?></span>
                </label>
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('password.request')); ?>">
                        <?php echo e(__('Esqueceu sea senha?')); ?>
...
<?php endif; ?>
<?php /**PATH /home/icaro/Área de Trabalho/developer/ProjetoEntra21-22-PHP/balcao-brasil/resources/views/auth/login.blade.php ENDPATH**/ ?>