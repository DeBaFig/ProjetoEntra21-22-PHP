        ...
        $viewData['info'] =
            [
                "denize" => ['name' => "Denize Bassi Figueiredo", 'city' => "Joinville - SC", 'img' => "denize.jpg", 'desc' => "Desde jovem sou atraída por tecnologia, minhas primeiras linhas de código foram em VisualBasic, hoje mais madura, acumulando uma variedade de cursos, mas também uma desenvoltura profissional focada em auto-desenvolvimento e compartilhamento de conhecimentos. Minha motivação é zelar por minha família e constantemente aprender algo novo.", 'link' => "https://github.com/DeBaFig/", 'site' => "https://www.linkedin.com/in/dbfigueiredo/"],
                    ...
                    "Bruno" => ['name' => "Bruno de Souza", 'city' => "Penha - SC", 'img' => "bruno.jpg", 'desc' => "Nascido em Belo Horizonte (MG) há 18 anos. Interesse por informática e programação desde muito tempo, e trabalhando na área de hardware há quase dois anos. Participar do Entra21 me despertou mais vontade de aprender e progredir na área! Atualmente também cursando superior de Análise e Desenvolvimento de Sistemas.", 'link' => "https://github.com/brwnosouza", 'site' => "https://www.linkedin.com/in/brunodesouzabs/"],
                    ...
                    "Lucas" => ['name' => "Lucas Bernardelli dos Passos", 'city' => "Balneário Camboriú - SC", 'img' => "lucas.jpg", 'desc' => "Acadêmico de Engenharia de Software e estudante de desenvolvimento web. Na trilha da construção do conhecimento necessário para contribuir para a sociedade de maneira mais produtiva, criativa e ágil. Buscando desenvolver de maneira sólida as habilidades para a construção de uma carreira. Excelente comunicador, buscador de conhecimento e apaixonado por tecnologia.", 'link' => "https://github.com/PassosLucasB" , 'site' => ""],
                    "Adriano" => ['name' => "Instrutor - Adriano Machado", 'city' => "Guaratuba - PR", 'img' => "adriano.jpg", 'desc' => "Gestor de Tecnologia da Informação. Analista de Infraestrutura Linux. Programador PHP. DBA MySQL. Programador Shell Script, Python. Experiência em RaspBerry, Fedora, Ubuntu, Centos, RedHat e outros. Redes TCP/IP, Modbus, CAN. Experiência Gestão de projetos.", 'link' => "https://github.com/Machado-tec" , 'site' => ""]
            ];
