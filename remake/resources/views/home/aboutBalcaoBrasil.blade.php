...
<!-- <div class="bg-green-400"> -->
  <!-- <div class="bg-gradient-to-r from-sky-200"> -->
    <section class="text-zic-50 body-font">
        <div class="container px-5 py-24 mx-auto flex flex-wrap">
          <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
            <img alt="feature" class="object-cover object-center h-full w-full" src="{{ asset('assets/img/team.png') }}">
          </div>
          <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
            <div class="flex flex-col mb-10 lg:items-start items-center">
              <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-lime-200 text-lime-800 mb-5">
              ...
              <div class="flex-grow">
                ...
                <a class="mt-3 text-lime-800 inline-flex items-center hover:bg-lime-200 rounded-full rounded-size" href="{{ route('home') }}">Volte para a página inicial
            ...
            <div class="flex flex-col mb-10 lg:items-start items-center">
              ...
              <div class="flex-grow">
                ...
                <a class="mt-3 text-lime-800 inline-flex items-center hover:bg-lime-200 rounded-full" href="{{ route('sobre') }}">Saiba mais
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                  </svg>
                </a>
